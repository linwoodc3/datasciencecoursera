...
---
# R Script to Impose tidy-data Principles of UCI Human Activity Recognition Dataset
...
5. From the data set in step 4, creates a second, independent tidy data set with the average of each variable for each activity and each subject. To run this script:
